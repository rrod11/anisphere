...
Revision ID: c583c92d27ea
Revises:
Create Date: 2023-12-18 11:04:36.666750
...
def upgrade():
    ...
    sa.Column('user_id', sa.INTEGER(), nullable=True),
    sa.Column('dislikes', sa.Boolean(), nullable=False),
    ...
    sa.Column('hater', sa.Boolean(), nullable=False),
    sa.Column('debate', sa.Boolean(), nullable=False),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE threadlikes SET SCHEMA {SCHEMA};")
