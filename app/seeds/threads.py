...
def seed_threads():
    seed_thread1= Thread(title="Best Ever", description=".", user_id=randint(1, 30), post_id=randint(1,122), fan=True)
    seed_thread2= Thread(title="Crazy Plot",  user_id=randint(1, 30) , description=".", post_id=randint(1,122), fan=True)
    seed_thread3 = Thread(title="Im addicted",  user_id=randint(1, 30), description="  .", post_id=randint(1,122), fan=True)
    seed_thread4 = Thread(title="Top of the top",  user_id=randint(1, 30),  description=".", post_id=randint(1,122), fan=True)
    seed_thread5 = Thread(title="Better than life",  user_id=randint(1, 30), description=".", post_id=randint(1,122), fan=True)
    seed_thread6 = Thread(title="Cant even begin to explain",  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread7 = Thread(title="They did that",  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread8 = Thread(title="30/30",  user_id=randint(1, 30),  description="", post_id=randint(1,122), fan=True)
    seed_thread9 = Thread(title="i'd definitely watch again",  user_id=randint(1, 30),  description="", post_id=randint(1,122), fan=True)
    seed_thread10 = Thread(title="where do i sign up",  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread11 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread12 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread13 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread14 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread15 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread16 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread17 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
    seed_thread18 = Thread(title=choice(animeReviews),  user_id=randint(1, 30), description="", post_id=randint(1,122), fan=True)
